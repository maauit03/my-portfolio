...
const Navbar = () => {
    return (
    <div>
        <nav className="bg-yellow-300 rounded-4xl w-2xl ">
        <div className="mx-auto max-w-7xl px-2 sm:px-6 lg:px-8">
            ...
            <div className="flex flex-1 items-center justify-center sm:items-stretch sm:justify-start">
                ...
                <div className="flex space-x-4">
                    ...
                    <a href="#" className="rounded-md px-3 py-2 text-sm font-medium text-gray-800 hover:bg-gray-700 hover:text-white">Resume</a>
                    <a href="#" className="rounded-md px-3 py-2 text-sm font-medium text-gray-800 hover:bg-gray-700 hover:text-white">Projects</a>
                    <a href="#" className="rounded-md px-3 py-2 text-sm font-medium text-gray-800 hover:bg-gray-700 hover:text-white">Contact</a>
                </div>
                </div>
            </div>
